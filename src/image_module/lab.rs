use csv::Reader;
use image::{DynamicImage, ImageBuffer, ImageResult, Rgb, Rgba};
use line_drawing::XiaolinWu;
use palette::{IntoColor, Lab, Laba, Mix, Srgb, Srgba};
use rayon::prelude::*;
...
impl LabBuf for LabaImageBuffer {
    ...
    fn put_pixel(&mut self, x: u32, y: u32, value: &Self::LabType) {
        self.buffer.put_pixel(
            ...
            y,
            Rgba::<f32> {
                0: [value.l, value.a, value.b, value.alpha],
            },
        );
    }
    fn new(width: u32, height: u32) -> Self {
